      ...
      <div className='bg-white rounded-2xl shadow-lg p-8 max-w-xl w-full relative'>
       ...
       <div className='w-24 h-24 rounded-full text-white flex items-center justify-center text-[30px] border-2 bg-black border-white'>
        {userData?.name.slice(0,1).toUpperCase()}
            ...
            <button className='w-full bg-[black] active:bg-[#454545] text-white py-2 rounded-md front-medium transition cursor-pointer' disabled={loading} onClick={handleEditProfile}>{loading?<ClipLoader size={30} color='white'/>:"Save Changes"}</button>
          </form>
